        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SocialSecurityNumber = table.Column<DateTime>(maxLength: 12, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DoubleRoom = table.Column<bool>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    StartBookDate = table.Column<DateTime>(nullable: false),
                    EndBookDate = table.Column<DateTime>(nullable: false),
                    HotelRoomId = table.Column<int>(nullable: false),
                    CustomerId = table.Column<int>(nullable: false),
                    InvoiceId = table.Column<int>(nullable: false),
                    Annulled = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
